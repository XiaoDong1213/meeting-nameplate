...
|------|-----|--------------|
| Primary | `#0070C0` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Primary Hover | `#005A9E` | `--color-primary-hover` |
| Primary Pressed | `#004C86` | `--color-primary-pressed` |
| Secondary | `#1A4A73` | `--color-secondary` |
| On Secondary | `#FFFFFF` | `--color-on-secondary` |
| Accent/CTA | `#0070C0` | `--color-accent` |
| On Accent/CTA | `#FFFFFF` | `--color-on-accent` |
| Background | `#F3F7FB` | `--color-background` |
| Foreground | `#1A2332` | `--color-foreground` |
| Card | `#FFFFFF` | `--color-card` |
| Card Foreground | `#1A2332` | `--color-card-foreground` |
| Muted | `#E8F1F8` | `--color-muted` |
| Muted Foreground | `#5A6A7A` | `--color-muted-foreground` |
| Border | `#D4DEE8` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| On Destructive | `#FFFFFF` | `--color-on-destructive` |
| Ring | `#0070C0` | `--color-ring` |

**Color Notes:** User-specified `#0070C0` as brand primary. Swiss / minimal office-tool surfaces. Desktop CJK UI uses Microsoft YaHei UI, not Outfit.
