...
echo [2/3] Building 会议桌牌打印系统...
"%PYTHON%" -m PyInstaller --noconfirm --clean "packaging\会议桌牌打印系统.spec"
if errorlevel 1 (
    echo.
...
echo.
echo ========================================
echo   Meeting Nameplate build completed!
echo ========================================
echo.
echo EXE folder:
...
echo Open Inno Setup 7: packaging\会议桌牌打印系统.iss
echo.
pause
endlocal
